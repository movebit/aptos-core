module SwapDeployer::AnimeSwapPoolV1Library {
  ...
  const ACCES_JRY_COLLECTION_URI: vector<u8> = b"https://otjbxblyfunmfblzdegw.supabase.co/storage/1/object/public/aptogotchi/bowtie,png";
  ...
  public fun get_amount_out(amount_in: u64, reserve_in: u64, reserve_out: u64, swap_fee: u64): u64 {
  ...
  public fun get_amount_in(amount_out: u64, reserve_in: u64, reserve_out: u64, swap_fee: u64): u64 {
  ...
  public fun register_coin<CoinType>(account: &signer) {
